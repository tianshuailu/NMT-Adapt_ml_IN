# This code snippet is from https://github.com/facebookresearch/fairseq/issues/2120
...
def main() -> None:
    ...
    parser.add_argument("--corpus-data", type=str, required=True,
                        help="The path pattern (glob) to all tokenized corpus files (train, test, val).")
